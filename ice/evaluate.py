...
def main():
    ...
    if True:
        ...
        dir2 = 'models/final-BBLN-crps-explore_20230809_03:17/'
        ensemble = MajorityVoteAgent([
            NNAgent.load_model(dir1 + 'frame_0005900000.pt', device=device, ucb=True),
            NNAgent.load_model(dir1 + 'frame_0006000000.pt', device=device, ucb=True),
            NNAgent.load_model(dir1 + 'frame_0006100000.pt', device=device, ucb=True),
            NNAgent.load_model(dir1 + 'frame_0006200000.pt', device=device, ucb=True),
            NNAgent.load_model(dir2 + 'frame_0005900000.pt', device=device, ucb=True),
            NNAgent.load_model(dir2 + 'frame_0006000000.pt', device=device, ucb=True),
            NNAgent.load_model(dir2 + 'frame_0006100000.pt', device=device, ucb=True),
            NNAgent.load_model(dir2 + 'frame_0006200000.pt', device=device, ucb=True),
        ])
        tournament.add_agent('LIVE-Version2-UCB', ensemble)
    ...
    if True:
        ...
        dir3 = 'models/final-BBLN-crps-explore-adv-RERUN_20230809_11:10/'
        dir4 = 'models/final-BBLN-crps-explore-adv-RERUN_20230809_11:15/'
        ensemble = MajorityVoteAgent([
            NNAgent.load_model(dir3 + 'frame_0000600000.pt', device=device),
            NNAgent.load_model(dir4 + 'frame_0000600000.pt', device=device),
        ])
        tournament.add_agent('RERUN-CAND1', ensemble)
